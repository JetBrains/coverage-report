...
public class SortTest {
    ...
    public void test_sort_by_line() {
        ...
        final ClassInfo ci1 = new IDEACoverageClassInfo(projectData, cn1, cd1, Collections.<ClassData>emptyList());

        final String cn2 = "Class2";
        final ClassData cd2 = createClassData(cn2, 2, 2);
        final ClassInfo ci2 = new IDEACoverageClassInfo(projectData, cn2, cd2, Collections.<ClassData>emptyList());
